...
export class ProductsService{
  api = 'http://localhost:3000/Candies';
  ...
  getDataById(id: number | undefined): Observable<Products> {
  ...
  addProduct(product: Products){
    this.http.post(this.api , this.product).toPromise().then(data=>{
      console.log(data);
    });
  ...
  //     new Products(549, 'SOUFFLE CHERRY ', 'Candies', typedict[1], 'by wieght', 1800, 'Tender soufflé with cherry taste in chocolate glaze.', 'http://www.rakhat.kz/app/uploads/cache/2017/07/So-vkusom-vishni-800x600-c-default.jpg'),
  ...
  //     new Products(548, 'Test', 'Chocolate', typedict[1], 'by wieght', 1000,  'Tender souffle with vanilla flavor in chocolate glaze.', 'http://www.rakhat.kz/app/uploads/cache/2017/07/Kok-tem-800x600-c-default.jpg'),
